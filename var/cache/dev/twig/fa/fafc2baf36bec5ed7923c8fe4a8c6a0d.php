...
class __TwigTemplate_c19793553717a9e1b8f0b7ae3386facf extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 10, $this->source); })()), "user", [], "any", false, false, false, 10)) {
            ...
            // line 12
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "user", [], "any", false, false, false, 12), "userIdentifier", [], "any", false, false, false, 12), "html", null, true);
            yield ", <a href=\"";
...
";
    ...
    {
        return array (  135 => 23,  127 => 18,  122 => 15,  114 => 12,  111 => 11,  109 => 10,  106 => 9,  100 => 7,  98 => 6,  95 => 5,  85 => 4,  65 => 2,  54 => 4,  51 => 3,  49 => 2,  46 => 1,);
    }
